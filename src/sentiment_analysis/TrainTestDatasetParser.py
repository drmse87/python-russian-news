...
class DatasetParser:
    ...
    def __init__(self, training_set, test_set):
        ...
        if training_set not in DatasetParser.VALID_TRAINING_SETS or \
            test_set not in DatasetParser.VALID_TEST_SETS:
        ...
        if (training_set == 'imdb' and test_set == 'imdb'):
            ...
            self.target_names = DatasetParser.TARGET_NAMES_TWO_CLASSES
            ...
            self.target_names = DatasetParser.TARGET_NAMES_THREE_CLASSES
        else:
