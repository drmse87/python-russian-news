...
parser.add_argument('-algorithm', '--algorithm', dest='algorithm', default='MNB', choices=['MNB', 'SVM'], help='Algorithm.')
parser.add_argument('-vectorizer', '--vectorizer', dest='vectorizer', default='tf-idf', choices=['tf-idf', 'count'], help='Vectorizer (feature [count], or fractional [tf-idf] count).')
parser.add_argument('-size', '--training_set_size', dest='training_set_size', type=int, help='Training set size.')
parser.add_argument('-ngram', '--ngram_length', dest='ngram_length', default='unigram', help='N-gram length.', choices=['unigram', 'bigram', 'trigram'])
